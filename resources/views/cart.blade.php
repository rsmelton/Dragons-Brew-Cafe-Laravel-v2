...
{{-- $userCartItems is coming from the index controller in the CartController 
it is basically finding all the users cart items and returning them to this view --}}
        ...
        <template x-if="$store.cart.cartTotalQuantity > 0">
            <div>
                <table class="min-w-full divide-y divide-gray-200 text-sm text-left">
                    ...
                    <tbody  
                           class="divide-y divide-gray-200 bg-gray-300"
                    >
